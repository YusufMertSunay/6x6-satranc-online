...
(function () {
  ...
  const TRANSLATIONS = {
    tr: {
      ...
      'lobby.blockFromHistoryTitle': 'Bu oyuncuyu engelle',
      ...
      'analysis.engineToggleTitle': 'Motoru aç/kapat',
      'analysis.engineOn': 'Motor Açık',
      'analysis.engineOff': 'Motor Kapalı',
      'analysis.engineDisabled': 'Motor kapalı',
      ...
      'chat.playerRateLimitHint': 'Rakibin cevap verene kadar 3. mesajı gönderemezsin.',
      'chat.spectatorRateLimitHint': 'Başka biri araya yazana kadar mesaj gönderemezsin.',
      'chat.mergedRateLimitHint': 'Karşı taraf cevap verene kadar art arda 3. mesajı gönderemezsin.',
    ...
    en: {
      ...
      'lobby.blockFromHistoryTitle': 'Block this player',
      ...
      'analysis.engineToggleTitle': 'Turn the engine on/off',
      'analysis.engineOn': 'Engine On',
      'analysis.engineOff': 'Engine Off',
      'analysis.engineDisabled': 'Engine off',
      ...
      'chat.playerRateLimitHint': "You can't send a 3rd message until your opponent replies.",
      'chat.spectatorRateLimitHint': 'You need to wait for someone else to post before sending another message.',
      'chat.mergedRateLimitHint': "You can't send a 3rd message in a row until the other side replies.",
